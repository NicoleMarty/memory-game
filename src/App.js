...
class App extends Component {
  ...
  chooseFriend = id => {
    ...
    if (clickedDup[0].clicked) {
      ...
      correctClicks = 0
      clickMessage =
        "Oh no! You've pledged your loyalty to the same mean queen twice! Now she rules. Get lost peasant!"
      ...
      clickMessage =
        "Your betrayal skills are on point! Keep it up if you're going to be queen."
      ...
      clickMessage =
        "Wow! You're vicious! Obviously you deserve to be crowned the most fabulous of all mean girls."
      topScore = 12
      this.setState({ topScore })
